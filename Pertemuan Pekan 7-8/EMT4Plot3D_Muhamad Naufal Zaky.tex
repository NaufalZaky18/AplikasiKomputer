...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3D_Muhamad Naufal Zaky-001.png}
\begin{eulerprompt}
>plot3d("x^2+x*sin(y)",-5,5,0,6*pi):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3D_Muhamad Naufal Zaky-002.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-003.png}
\begin{eulerprompt}
>aspect(); plot3d("10*x^2-y^2",-10,10,0,50):
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-004.png}
\begin{eulerprompt}
>t=0*pi:0.05:1*pi; y=(-pi:0.1:0)'; ...
>plot3d(cos(t)+sin(y),sin(t)+sin(y),t,color=green,angle=45°):
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-005.png}
...
>plot3d("x^2+y^2"):
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-006.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-007.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-008.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-009.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-010.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-011.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-012.png}
\begin{eulerprompt}
>function f(r) := exp(-r/2)*cos(r); ...
>plot3d("f(x^2+y^2)",>polar,scale=[1,1,0.4],r=pi,frame=3,zoom=4):
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-013.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-014.png}
\begin{eulerprompt}
>plot3d("x^2+1",a=-1,b=1,rotate=2,grid=5):
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-015.png}
\begin{eulerprompt}
>plot3d("sqrt(25-x^2)",a=0,b=5,rotate=1):
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-016.png}
\begin{eulerprompt}
>plot3d("x*sin(x)",a=0,b=6pi,rotate=2):
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-017.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-018.png}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-019.png}
\begin{eulerprompt}
>plot3d("exp(x*y)",angle=100°,>contour,color=green):
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-020.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-021.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-022.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-023.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-025.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-026.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-027.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-028.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-029.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-030.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-031.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-032.png}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-035.png}
\begin{eulerprompt}
>c=1; d=1;
>plot3d("((x^2+y^2-c^2)^2+(z^2-1)^2)*((y^2+z^2-c^2)^2+(x^2-1)^2)*((z^2+x^2-c^2)^2+(y^2-1)^2)-d",r=2,<frame,>implicit,>user): 
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-036.png}
\begin{eulerprompt}
>plot3d("x^2+y^2+4*x*z+z^3",>implicit,r=2,zoom=2.5):
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-037.png}
...
>scale=1.4,height=50°):
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-039.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-040.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-042.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-046.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-047.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-048.png}
\begin{eulerprompt}
>t=linspace(0,4pi,1000); plot3d(cos(t),sin(t),t/2pi,>wire, ...
>linewidth=3,wirecolor=blue):
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-049.png}
\begin{eulerprompt}
>X=cumsum(normal(3,100)); ...
> plot3d(X[1],X[2],X[3],>anaglyph,>wire):
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-050.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-051.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-052.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-053.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-054.png}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-055.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-056.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-057.png}
\begin{eulerprompt}
>Z=intrandom(5,100,6); v=zeros(5,6); ...
>loop 1 to 5; v[#]=getmultiplicities(1:6,Z[#]); end; ...
>columnsplot3d(v',scols=1:5,ccols=[1:5]):
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-058.png}
...
>level=[-2;0],n=100):
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-059.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-064.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-065.png}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-066.png}
\begin{eulercomment}
...
>myplot(x,y,z):
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-067.png}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-068.png}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-069.png}
\begin{eulerprompt}
>pov3d("x^2+y^2",zoom=3);
\end{eulerprompt}
\eulerimg{25}{images/EMT4Plot3D_Muhamad Naufal Zaky-070.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/EMT4Plot3D_Muhamad Naufal Zaky-071.png}
\begin{eulercomment}
...
>  <fscale,zoom=3);
\end{eulerprompt}
\eulerimg{25}{images/EMT4Plot3D_Muhamad Naufal Zaky-072.png}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT4Plot3D_Muhamad Naufal Zaky-073.png}
\begin{eulercomment}
...
>  w=500,h=300);
\end{eulerprompt}
\eulerimg{16}{images/EMT4Plot3D_Muhamad Naufal Zaky-074.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT4Plot3D_Muhamad Naufal Zaky-075.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{18}{images/EMT4Plot3D_Muhamad Naufal Zaky-076.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{25}{images/EMT4Plot3D_Muhamad Naufal Zaky-077.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{25}{images/EMT4Plot3D_Muhamad Naufal Zaky-078.png}
...
>povend;
\end{eulerprompt}
\eulerimg{25}{images/EMT4Plot3D_Muhamad Naufal Zaky-079.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{25}{images/EMT4Plot3D_Muhamad Naufal Zaky-080.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{25}{images/EMT4Plot3D_Muhamad Naufal Zaky-081.png}
...
>povend();
\end{eulerprompt}
\eulerimg{25}{images/EMT4Plot3D_Muhamad Naufal Zaky-083.png}
\begin{eulerprompt}
>povstart(angle=70°,height=50°,zoom=4);
\end{eulerprompt}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{25}{images/EMT4Plot3D_Muhamad Naufal Zaky-084.png}
\eulerheading{Objek Jaringan (Mesh)}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{25}{images/EMT4Plot3D_Muhamad Naufal Zaky-085.png}
...
\end{eulerprompt}
\eulerimg{24}{images/EMT4Plot3D_Muhamad Naufal Zaky-086.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/EMT4Plot3D_Muhamad Naufal Zaky-087.png}
...
>povend(h=320,w=480);
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot3D_Muhamad Naufal Zaky-088.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{25}{images/EMT4Plot3D_Muhamad Naufal Zaky-091.png}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-093.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot3D_Muhamad Naufal Zaky-095.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT4Plot3D_Muhamad Naufal Zaky-097.png}
\begin{eulerprompt}
>reset();
\end{eulerprompt}
\end{eulernotebook}
