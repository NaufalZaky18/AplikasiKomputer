...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot2D_Muhamad Naufal Zaky-001.png}
\begin{eulerprompt}
>reset;
\end{eulerprompt}
\begin{eulercomment}
...
>plot2d("x^4-x",grid=6):
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot2D_Muhamad Naufal Zaky-002.png}
\begin{eulerprompt}
>hold off;
>window(ow);
\end{eulerprompt}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Muhamad Naufal Zaky-003.png}
\begin{eulerprompt}
>aspect();
>reset;
\end{eulerprompt}
...
>plot2d("x^2"):
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot2D_Muhamad Naufal Zaky-004.png}
\begin{eulerprompt}
>aspect(1.5); plot2d("x^3-x"):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-005.png}
\begin{eulerprompt}
>a:=5.6; plot2d("exp(-a*x^2)/a"); insimg(30); // menampilkan gambar hasil plot setinggi 30 baris
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-006.png}
\begin{eulercomment}
...
>plot2d("x^3-x",-1,2):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-007.png}
\begin{eulerprompt}
>plot2d("sin(x)",-2*pi,2*pi): // plot sin(x) pada interval [-2pi, 2pi]
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-008.png}
\begin{eulerprompt}
>plot2d("cos(x)","sin(3*x)",xmin=0,xmax=2pi):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-009.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot2D_Muhamad Naufal Zaky-010.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot2D_Muhamad Naufal Zaky-011.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-012.png}
\begin{eulerprompt}
>plot2d("sin(x)+cos(2*x)",0,4pi):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-013.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-014.png}
\begin{eulerprompt}
>plot2d("x^x",r=1.2,cx=1,cy=1):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-015.png}
\begin{eulercomment}
...
>plot2d("log(x)",-0.1,2):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-016.png}
\begin{eulercomment}
...
>plot2d("x^3-x",>square):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-017.png}
\begin{eulerprompt}
>plot2d(''integrate("sin(x)*exp(-x^2)",0,x)'',0,2): // plot integral
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-018.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-019.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-020.png}
\begin{eulerprompt}
>a:=5.6; expr &= exp(-a*x^2)/a; // mendefinisikan ekspresi
>plot2d(expr,-2,2): // plot dari -2 sampai 2
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-021.png}
\begin{eulerprompt}
>plot2d(expr,r=1,thickness=2): // plot di persegi sekitar (0,0)
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-022.png}
\begin{eulerprompt}
>plot2d(&diff(expr,x),>add,style="--",color=red): // menambahkan plot yang lain
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-023.png}
\begin{eulerprompt}
>plot2d(&diff(expr,x,2),a=-2,b=2,c=-2,d=1): // plot dalam persegi panjang
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-024.png}
\begin{eulerprompt}
>plot2d(&diff(expr,x),a=-2,b=2,>square): // menjaga plot tetap persegi
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-025.png}
\begin{eulerprompt}
>plot2d("x^2",0,1,steps=1,color=red,n=10):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-026.png}
\begin{eulerprompt}
>plot2d("x^2",>add,steps=2,color=blue,n=10):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-027.png}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-028.png}
\begin{eulerprompt}
>plot2d("f",0,1;0.4): // plot dengan a=0.4
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-029.png}
\begin{eulerprompt}
>plot2d(\{\{"f",0.2\}\},0,1): // plot dengan a=0.2
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-030.png}
\begin{eulerprompt}
>plot2d(\{\{"f(x,b)",b=0.1\}\},0,1): // plot dengan 0.1
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-031.png}
\begin{eulerprompt}
>function f(x) := x^3-x; ...
>plot2d("f",r=1):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-032.png}
\begin{eulercomment}
...
>plot2d(f,0,2):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-033.png}
\begin{eulercomment}
...
>plot2d(expr,0,3pi):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-034.png}
\begin{eulerprompt}
>function f(x) &= x^x;
>plot2d(f,r=1,cx=1,cy=1,color=blue,thickness=2);
>plot2d(&diff(f(x),x),>add,color=red,style="-.-"):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-035.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-036.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Muhamad Naufal Zaky-037.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Muhamad Naufal Zaky-038.png}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot2D_Muhamad Naufal Zaky-039.png}
\begin{eulerprompt}
>aspect(1.5); plot2d("sin(x)",0,2pi); plot2d("cos(x)",color=blue,style="--",>add):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-040.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-041.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-042.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-044.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-046.png}
\begin{eulercomment}
...
>plot2d(x,y):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-047.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-048.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-049.png}
\begin{eulerprompt}
>plot2d(["sin(x)","cos(x)"],0,2pi): // ekspresi dari plot vektor
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-050.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-051.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-052.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-053.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-054.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-055.png}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-056.png}
\begin{eulerprompt}
>expr := "log(x)/x"; ...
>  plot2d(expr,0.5,5,title="y="+expr,xl="x",yl="y"); ...
>  label("(1,0)",1,0); label("Max",E,expr(E),pos="lc"):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-057.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-058.png}
\begin{eulercomment}
...
>tcolor=black,>left):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-059.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-060.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-061.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-062.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-063.png}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-064.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-065.png}
\begin{eulercomment}
...
>  x=0.7,y=0.2):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-066.png}
\begin{eulercomment}
\end{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-067.png}
\begin{eulerprompt}
>plot2d("exp(x)*sin(x)",user=true, ...
>  title="+/- or cursor keys (return to exit)"):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-068.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-069.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-070.png}
\begin{eulercomment}
...
>plotf(nd):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-071.png}
\begin{eulercomment}
...
> figure(0):
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot2D_Muhamad Naufal Zaky-072.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-073.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-074.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-075.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-076.png}
\begin{eulercomment}
Ada juga kotak teks.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-077.png}
\begin{eulerprompt}
>plot2d(["exp(x)","1+x"],color=[black,blue],style=["-","-.-"]):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-078.png}
\begin{eulerprompt}
...
> reset():
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot2D_Muhamad Naufal Zaky-079.png}
\begin{eulercomment}
...
> reset:
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot2D_Muhamad Naufal Zaky-080.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-081.png}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-082.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-083.png}
\begin{eulerprompt}
>p=polyfit(xdata,ydata,1); // mendapatkan garis regresi
>plot2d("polyval(p,x)",>add,color=red): // tambahkan plot garis
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-084.png}
...
>figure(0):
\end{eulerprompt}
\eulerimg{16}{images/EMT4Plot2D_Muhamad Naufal Zaky-085.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Plot2D_Muhamad Naufal Zaky-086.png}
\begin{eulerprompt}
>t=linspace(0,2pi,6); ...
>plot2d(cos(t),sin(t),>filled,style="/",fillcolor=red,r=1.2):
\end{eulerprompt}
\eulerimg{16}{images/EMT4Plot2D_Muhamad Naufal Zaky-087.png}
\begin{eulerprompt}
>t=linspace(0,2pi,6); plot2d(cos(t),sin(t),>filled,style="#"):
\end{eulerprompt}
\eulerimg{16}{images/EMT4Plot2D_Muhamad Naufal Zaky-088.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Plot2D_Muhamad Naufal Zaky-089.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Plot2D_Muhamad Naufal Zaky-090.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Plot2D_Muhamad Naufal Zaky-091.png}
\begin{eulercomment}
...
> plot2d(t,t,add=true):
\end{eulerprompt}
\eulerimg{16}{images/EMT4Plot2D_Muhamad Naufal Zaky-092.png}
\begin{eulercomment}
...
>plot2d(t,y):
\end{eulerprompt}
\eulerimg{16}{images/EMT4Plot2D_Muhamad Naufal Zaky-093.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Plot2D_Muhamad Naufal Zaky-094.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Plot2D_Muhamad Naufal Zaky-096.png}
\begin{eulerprompt}
>plot2d("cos(x)","sin(x)^3",xmin=0,xmax=2pi,>filled,style="/"):
\end{eulerprompt}
\eulerimg{16}{images/EMT4Plot2D_Muhamad Naufal Zaky-097.png}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Plot2D_Muhamad Naufal Zaky-099.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Plot2D_Muhamad Naufal Zaky-100.png}
\begin{eulerprompt}
>t=linspace(0,1,1000); r=exp(-t); x=r*cos(2pi*t); y=r*sin(2pi*t);
>plot2d(x,y,r=1):
\end{eulerprompt}
\eulerimg{16}{images/EMT4Plot2D_Muhamad Naufal Zaky-101.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Plot2D_Muhamad Naufal Zaky-104.png}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot2D_Muhamad Naufal Zaky-105.png}
\begin{eulerprompt}
>aspect(1.25); r=linspace(0,1,50); a=linspace(0,2pi,200)'; z=r*exp(I*a);
>plot2d(exp(z),cgrid=[40,10]):
\end{eulerprompt}
\eulerimg{23}{images/EMT4Plot2D_Muhamad Naufal Zaky-106.png}
\begin{eulerprompt}
>r=linspace(0,1,10); a=linspace(0,2pi,40)'; z=r*exp(I*a);
>plot2d(exp(z),>points,>add):
\end{eulerprompt}
\eulerimg{23}{images/EMT4Plot2D_Muhamad Naufal Zaky-107.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{23}{images/EMT4Plot2D_Muhamad Naufal Zaky-109.png}
...
\end{eulerprompt}
\eulerimg{23}{images/EMT4Plot2D_Muhamad Naufal Zaky-110.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{23}{images/EMT4Plot2D_Muhamad Naufal Zaky-111.png}
\begin{eulerprompt}
>columnsplot(cumsum(random(10)),style="/",color=blue):
\end{eulerprompt}
\eulerimg{23}{images/EMT4Plot2D_Muhamad Naufal Zaky-112.png}
\begin{eulercomment}
...
>title("Temperature"):
\end{eulerprompt}
\eulerimg{23}{images/EMT4Plot2D_Muhamad Naufal Zaky-113.png}
\begin{eulerprompt}
>k=0:10;
>plot2d(k,bin(10,k),>bar):
\end{eulerprompt}
\eulerimg{23}{images/EMT4Plot2D_Muhamad Naufal Zaky-114.png}
\begin{eulerprompt}
>plot2d(k,bin(10,k)); plot2d(k,bin(10,k),>points,>add):
\end{eulerprompt}
\eulerimg{23}{images/EMT4Plot2D_Muhamad Naufal Zaky-115.png}
\begin{eulerprompt}
>plot2d(normal(1000),normal(1000),>points,grid=6,style=".."):
\end{eulerprompt}
\eulerimg{23}{images/EMT4Plot2D_Muhamad Naufal Zaky-116.png}
\begin{eulerprompt}
>plot2d(normal(1,1000),>distribution,style="O"):
\end{eulerprompt}
\eulerimg{23}{images/EMT4Plot2D_Muhamad Naufal Zaky-117.png}
\begin{eulerprompt}
>plot2d("qnormal",0,5;2.5,0.5,>filled):
\end{eulerprompt}
\eulerimg{23}{images/EMT4Plot2D_Muhamad Naufal Zaky-118.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{23}{images/EMT4Plot2D_Muhamad Naufal Zaky-119.png}
\begin{eulercomment}
...
>plot2d(x,y,>bar):
\end{eulerprompt}
\eulerimg{23}{images/EMT4Plot2D_Muhamad Naufal Zaky-120.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{23}{images/EMT4Plot2D_Muhamad Naufal Zaky-121.png}
\begin{eulerprompt}
>n=10; i=0:n; ...
>plot2d(i,bin(n,i)/2^n,a=0,b=10,c=0,d=0.3); ...
>plot2d(i,bin(n,i)/2^n,points=true,style="ow",add=true,color=blue):
\end{eulerprompt}
\eulerimg{23}{images/EMT4Plot2D_Muhamad Naufal Zaky-122.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{23}{images/EMT4Plot2D_Muhamad Naufal Zaky-123.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{23}{images/EMT4Plot2D_Muhamad Naufal Zaky-124.png}
\begin{eulerprompt}
>k=0:10; m=bin(10,k); x=(0:11)-0.5; plot2d(x,m,>bar):
\end{eulerprompt}
\eulerimg{23}{images/EMT4Plot2D_Muhamad Naufal Zaky-125.png}
\begin{eulerprompt}
>columnsplot(m,k):
\end{eulerprompt}
\eulerimg{23}{images/EMT4Plot2D_Muhamad Naufal Zaky-126.png}
\begin{eulerprompt}
>plot2d(random(600)*6,histogram=6):
\end{eulerprompt}
\eulerimg{23}{images/EMT4Plot2D_Muhamad Naufal Zaky-127.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{23}{images/EMT4Plot2D_Muhamad Naufal Zaky-128.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{23}{images/EMT4Plot2D_Muhamad Naufal Zaky-129.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{23}{images/EMT4Plot2D_Muhamad Naufal Zaky-130.png}
\begin{eulerprompt}
>plot2d(normal(1,1000),>distribution); ...
>  plot2d("qnormal(x)",color=red,thickness=2,>add):
\end{eulerprompt}
\eulerimg{23}{images/EMT4Plot2D_Muhamad Naufal Zaky-131.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{23}{images/EMT4Plot2D_Muhamad Naufal Zaky-132.png}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-134.png}
\begin{eulerprompt}
>expr := "2*x^2+x*y+3*y^4+y"; // definisi ekspresi f(x,y)
>plot2d(expr,level=0): // Solusi dari f(x,y)=0
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-135.png}
\begin{eulerprompt}
>plot2d(expr,level=0:0.5:20,>hue,contourcolor=white,n=200): // bagus
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-136.png}
\begin{eulerprompt}
>plot2d(expr,level=0:0.5:20,>hue,>spectral,n=200,grid=4): // lebih bagus
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-137.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-138.png}
\begin{eulerprompt}
>plot2d("x^3-y^2",>contour,>hue,>spectral):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-139.png}
\begin{eulerprompt}
>plot2d("x^3-y^2",level=0,contourwidth=3,>add,contourcolor=red):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-140.png}
\begin{eulerprompt}
>z=z+normal(size(z))*0.2;
>plot2d(z,level=0.5,a=-1,b=2,c=-2,d=1):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-141.png}
\begin{eulerprompt}
>plot2d(expr,level=[0:0.2:5;0.05:0.2:5.05],color=lightgray):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-142.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=1,r=4,n=100):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-143.png}
\begin{eulerprompt}
>plot2d("x^2+2*y^2-x*y",level=0:0.1:10,n=100,contourcolor=white,>hue):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-144.png}
\begin{eulercomment}
...
>plot2d(expr,level=[0;1],style="-",color=blue): // 0 <= f(x,y) <= 1
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-146.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-147.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=[0,2,4;1,3,5],style="/",r=2,n=100):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-148.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=-10:20,r=2,style="-",dl=0.1,n=100):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-149.png}
\begin{eulerprompt}
>plot2d("sin(x)*cos(y)",r=pi,>hue,>levels,n=100):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-150.png}
\begin{eulercomment}
...
>  level=[-2;0],n=100):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-152.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-154.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot2D_Muhamad Naufal Zaky-155.png}
\begin{eulercomment}
...
>logimpulseplot1(x,y):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-156.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-157.png}
\begin{eulerprompt}
>plot2d("exp(x+sin(x))",0,100,logplot=1):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-158.png}
\begin{eulerprompt}
>plot2d("exp(x+sin(x))",10,100,logplot=2):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-159.png}
\begin{eulerprompt}
>plot2d("gamma(x)",1,10,logplot=1):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-160.png}
\begin{eulerprompt}
>plot2d("log(x*(2+sin(x/100)))",10,1000,logplot=3):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-161.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D_Muhamad Naufal Zaky-162.png}
\eulerheading{Penyelesaian Penggunaan plot2d}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot2D_Muhamad Naufal Zaky-163.png}
\begin{eulerprompt}
>plot2d(&diff(f(x),x),color=blue): // menggambar grafik fungsi f'(x)
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot2D_Muhamad Naufal Zaky-164.png}
\begin{eulerprompt}
>plot2d(&f(x),>add):
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot2D_Muhamad Naufal Zaky-165.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot2D_Muhamad Naufal Zaky-166.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot2D_Muhamad Naufal Zaky-171.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{30}{images/EMT4Plot2D_Muhamad Naufal Zaky-172.png}
\begin{eulercomment}
